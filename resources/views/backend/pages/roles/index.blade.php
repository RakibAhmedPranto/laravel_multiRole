            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        <a href="{{route('admin.roles.create')}}" class="btn btn-primary text-white">Create New Role</a>
                    </p>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                    <a href="{{ route('admin.roles.edit', $role->id) }}" class="btn btn-success text-white">Edit</a>
